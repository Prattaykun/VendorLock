      ...
      <div className="grid grid-cols-12 gap-6 h-[calc(100vh-220px)] min-h-[640px]">
        ...
        <div className="col-span-4 sticky top-24 flex flex-col h-full bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-xl overflow-hidden relative shadow-2xl">
          ...
          <div className="flex-1 p-6 flex flex-col gap-6 overflow-y-auto">
            ...
            <div className="w-full bg-red-500/10 border border-red-500/20 rounded-lg p-3 mb-6 relative overflow-hidden">
               
              {/* Header Row: Title & Percentage */}
              <div className="flex items-start justify-between gap-2 mb-2">
                <div className="flex items-start gap-2 min-w-0 flex-1">
                  {/* Alert Icon */}
                  <svg className="w-4 h-4 mt-1 text-red-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
                  </svg>
                  <div className="min-w-0">
                    <h4 className="text-red-400 font-bold tracking-wide text-[10px] uppercase leading-tight break-words">
                      Policy Violation Risk
                    </h4>
                    <p className="text-[9px] text-red-300/80 mt-0.5 uppercase tracking-wider">
                      Immediate review needed
                    </p>
                  </div>
                </div>
                <span className="inline-flex items-center justify-center rounded-full border border-red-500/20 bg-red-500/10 px-2 py-0.5 text-red-400 font-bold text-[10px] leading-none whitespace-nowrap shrink-0">
                  92%
                </span>
              </div>

              {/* Description Paragraph */}
              <p className="text-slate-300 text-[11px] leading-snug pl-6 pr-1">
